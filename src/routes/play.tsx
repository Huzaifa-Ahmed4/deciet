...
const title = "Play Deceit — Set the Table & Deal the Secrets";
const description =
  "Add 3–10 players, choose how many impostors, flip on team mode, and pass the phone. Deceit deals the category and secret word for you.";
...
function Play() {
  ...
  useEffect(() => {
    persistState(state);
  }, [state.players, state.impostorCount, state.teamMode]);
