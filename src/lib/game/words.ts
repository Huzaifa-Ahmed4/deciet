...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    words: [
      { word: "Thunderstorm", clue: "It announces itself late" },
      { word: "Quicksand", clue: "Struggling makes it worse" },
      { word: "Volcano", clue: "Quiet for a very long time" },
      { word: "Glacier", clue: "Most of it stays hidden" },
      { word: "Fog", clue: "Arrives and erases everything" },
      { word: "Tornado", clue: "It doesn't knock first" },
      { word: "Coral reef", clue: "Beautiful, sharp, fragile" },
      { word: "Avalanche", clue: "One small sound too many" },
      { word: "Compost", clue: "Something dies, something grows" },
      { word: "Lightning", clue: "Here and gone, proof remains" },
      { word: "Tide", clue: "It always comes back" },
      { word: "Cave", clue: "Echoes give you away" },
      { word: "Wildfire", clue: "Starts smaller than a secret" },
      { word: "Rainbow", clue: "Only visible from one angle" },
      { word: "Swamp", clue: "Looks solid, isn't" },
      { word: "Eclipse", clue: "Everyone looks up at once" },
    ],
  },
  {
    id: "sports",
    label: "Sports & Games",
    words: [
      { word: "Penalty shootout", clue: "One kick, no excuses" },
      { word: "Chess", clue: "Losing happens in advance" },
      { word: "Hide and seek", clue: "Winning means not existing" },
      { word: "Arm wrestling", clue: "The face gives it away" },
      { word: "Relay race", clue: "Trust handed over mid-run" },
      { word: "Darts", clue: "Close counts for nothing" },
      { word: "Musical chairs", clue: "Someone always loses the seat" },
      { word: "Boxing", clue: "Hugging counts as strategy" },
      { word: "Marathon", clue: "A slow argument with yourself" },
      { word: "Bluff", clue: "The bet isn't the weapon" },
      { word: "Fencing", clue: "Polite, pointed, personal" },
      { word: "Rock paper scissors", clue: "Everyone swears there's a system" },
      { word: "Tug of war", clue: "Losing face-first" },
      { word: "Escape room", clue: "Locked in with your friends' flaws" },
      { word: "Jenga", clue: "The tower blames the last hand" },
      { word: "Bowling", clue: "Everyone watches your walk back" },
    ],
  },
  {
    id: "music",
    label: "Music & Sound",
    words: [
      { word: "Encore", clue: "Pretended it wasn't planned" },
      { word: "Earworm", clue: "It stays without paying rent" },
      { word: "Drum solo", clue: "Everyone waits for it to end" },
      { word: "Karaoke machine", clue: "Judgment with a score" },
      { word: "Voicemail", clue: "Recorded and regretted" },
      { word: "Autotune", clue: "Honesty, corrected" },
      { word: "Saxophone", clue: "Only ever played at night" },
      { word: "White noise", clue: "Something pretending to be nothing" },
      { word: "Mixtape", clue: "A confession in track order" },
      { word: "Feedback squeal", clue: "The machine argues back" },
      { word: "Lullaby", clue: "A song with one job" },
      { word: "One-hit wonder", clue: "Famous for a single thing" },
      { word: "Tuning fork", clue: "Everyone adjusts to it" },
      { word: "Echo", clue: "It repeats, never answers" },
      { word: "Silent disco", clue: "Dancing to what others can't hear" },
      { word: "Group chant", clue: "One voice becomes many" },
    ],
  },
  {
    id: "travel",
    ...
    words: [
      { word: "Lost luggage", clue: "It arrives after the trip" },
      { word: "Night bus", clue: "Sleeping upright among strangers" },
      { word: "Layover", clue: "A place you never chose" },
      { word: "Souvenir", clue: "Proof bought at the end" },
      { word: "Turbulence", clue: "Everyone looks at the wings" },
      { word: "Hitchhiking", clue: "Trusting a stranger's direction" },
      { word: "Customs", clue: "Declare what you're hiding" },
      { word: "Roadside motel", clue: "One night, no questions" },
      { word: "Ticket inspector", clue: "Appears exactly once" },
      { word: "Wrong turn", clue: "Discovered miles later" },
      { word: "Backpackers' hostel", clue: "Privacy traded for price" },
      { word: "Ferry", clue: "Slower, and that's the point" },
      { word: "Travel insurance", clue: "Paid to expect disaster" },
      { word: "Window seat", clue: "Worth negotiating for" },
      { word: "Tourist trap", clue: "Famous for being famous" },
      { word: "Jet lag", clue: "Your body stayed behind" },
    ],
  },
  {
    id: "work",
    label: "School & Work",
    words: [
      { word: "Pop quiz", clue: "Nobody saw it coming" },
      { word: "Team meeting", clue: "An email that became an hour" },
      { word: "Homework", clue: "Due before it's understood" },
      { word: "Performance review", clue: "Your year, summarised politely" },
      { word: "Detention", clue: "Time as punishment" },
      { word: "Group presentation", clue: "One person did the slides" },
      { word: "Intern", clue: "Experience paid in experience" },
      { word: "Resignation letter", clue: "Short, final, rehearsed" },
      { word: "Office gossip", clue: "Everyone knows, nobody said" },
      { word: "Deadline extension", clue: "Mercy with a new date" },
      { word: "Substitute teacher", clue: "Authority on borrowed time" },
      { word: "Overtime", clue: "Hours nobody remembers kindly" },
      { word: "School photo", clue: "One face you can't retake" },
      { word: "Exit interview", clue: "Honesty on the way out" },
      { word: "Report card", clue: "Folded before showing anyone" },
      { word: "Brainstorm", clue: "No bad ideas, allegedly" },
    ],
  },
  {
    id: "tech",
    label: "Technology",
    words: [
      { word: "Password", clue: "Secret by design, reused anyway" },
      { word: "Screenshot", clue: "Proof that outlives deletion" },
      { word: "Low battery", clue: "Panic measured in percent" },
      { word: "Spam folder", clue: "Where strangers promise riches" },
      { word: "Update available", clue: "Postponed forever" },
      { word: "Incognito mode", clue: "Private, or so it says" },
      { word: "Read receipt", clue: "Seen, and now it's awkward" },
      { word: "Captcha", clue: "Proving you're not a machine" },
      { word: "Terms and conditions", clue: "Agreed to, never read" },
      { word: "Autocorrect", clue: "Help that betrays you publicly" },
      { word: "Cloud backup", clue: "Somewhere, someone else's computer" },
      { word: "Group chat", clue: "Muted but never left" },
      { word: "Loading bar", clue: "The last 10% takes longest" },
      { word: "Screen recording", clue: "It watched everything" },
      { word: "Two-factor code", clue: "A second door, same house" },
      { word: "Algorithm", clue: "It knows what you'll watch next" },
    ],
  },
];
